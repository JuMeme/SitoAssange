    ...
    function initReactAnimations() {
        ...
        function TeamThoughtsModal({ isOpen, onClose }) {
            ...
            const teamMembers = [
                {
                    name: 'Leonardo',
                    text: "A parer mio, questa situazione ci fa comprendere più che mai quanto il mondo sia profondamente corrotto da stati che, pur di portare avanti i propri interessi, non esitano a compiere azioni disumane, spesso senza alcun consenso o trasparenza verso la propria popolazione. Mantengono le persone all'oscuro, mostrando solo la parte di realtà che fa loro comodo e condannando chi cerca semplicemente di rivelare la verità. Vedere come venga trattato un uomo che ha svolto il proprio lavoro con coraggio ci fa riflettere sulla fragilità dei valori proclamati, e quanto le libertà fondamentali possano essere ignorate quando interferiscono con il potere e gli interessi di pochi. È un chiaro monito su quanto il concetto di giustizia e trasparenza possa essere distorto per favorire chi detiene il controllo.",
                    image: 'i/leonardo.jpg'
                },
                {
                    name: 'Marco',
                    text: "Julian Assange mi fa riflettere, perché da una parte ammiro davvero il suo coraggio: si è esposto completamente pur di far vedere al mondo cose che altrimenti sarebbero rimaste nascoste, anche rischiando la sua libertà. Allo stesso tempo però il suo modo di agire apre un sacco di domande: fin dove arriva il diritto delle persone a sapere la verità e dove invece inizia il rischio di invadere la privacy o mettere qualcuno in pericolo? È come se con il suo gesto avesse messo tutti davanti a un bivio: scegliere tra la trasparenza assoluta e le conseguenze che questa può portare. E anche se non tutti condividono quello che ha fatto, è difficile non riconoscere che ci ha costretti a guardare in faccia temi che spesso preferiamo ignorare.",
                    image: 'i/marco.jpg'
                },
                {
                    name: 'Astrit',
                    text: "Assange secondo me rappresenta la resilienza e lo spirito non conformista che tutti i giornalisti dovrebbero avere: andare incontro a entità molto potenti come la CIA significa non solo rischiare il proprio lavoro, ma la propria vita per diffondere la verità, senza godere dei diritti concessi ai giornalisti. Si parla spesso che i segreti di stato siano necessari per mantenere la calma e la stabilità in un paese, tuttavia, tale 'tranquillità' è fin troppo spesso unilaterale poiché garantire la sicurezza di una nazione significa farlo a discapito di un'altra, creando cittadini di serie A e di serie B a livello globale. Mentre negli Stati Uniti gran parte della popolazione aveva una percezione distorta, o addirittura positiva, delle operazioni militari in Iraq e Afghanistan la realtà per i civili era quella di una violenza brutale, morti ingiustificate e totale mancanza di giustizia o di un processo equo. La diffusione di questi documenti ha reso molto scomode le nazioni più avvantaggiate, sentimento essenziale per realizzare che la guerra post 11 settembre era una finzione mediatica che nascondeva una realtà disumana. Dovrebbe esistere un premio Pulitzer con il nome di Julian Assange scritto sopra eppure siamo ancora qui a discutere se ciò che ha fatto fosse 'giusto' o 'sbagliato' mettendo in discussione l'essenza stessa del giornalismo investigativo.",
                    image: 'i/astrit.jpg'
                },
                {
                    name: 'Jacopo',
                    text: "Rispetto molto Assange perché ha scelto di rimanere fedele ai suoi ideali, trovando un problema e decidendo di dare tutto sé stesso a combattere per raggiungere il suo obbiettivo, rimanendo pronto a pagare i prezzi necessari. Anche se alla fine a 'gettato la spugna' lo ha fatto in una maniera che fa capire che non lo ha fatto totalmente ma semplicemente si è reso conto di esser diventato troppo vecchio e stanco per poter fare la differenza. Per quanto riguarda quello che hanno fatto gli stati americani di nascondere così tante informazioni soprattutto sulle pesanti violazioni dei diritti umani, trovo comprensibile che abbiano voluto insabbiare l'avvenimento di questi fatti il più possibile al fine di proteggere la loro reputazione e la stabilità nazionale, ma trovo comunque fastidio che tali avvenimenti si siano verificati così frequentemente, mostrando che non c'è stata un vero tentativo di controllare avvenimenti del genere che sono molto conosciuti e prevedibili. Oltre tutto credo che l'impedimento di tali azioni sia più lucrativo allo stato in questioni di costi, disciplina e immagine pubblica.",
                    image: 'i/jacopo.jpg'
                }
            ];
